...
namespace InflatablePalace.Cryptography.Algorithms
{
    public sealed class CAST5 : SymmetricAlgorithm
    {
        public CAST5()
        {
            this.LegalKeySizesValue = new KeySizes[] { new KeySizes(40, 128, 8) };
        ...
        sealed class CAST5Transform : IBlockTransform
        {
            ...
            public CAST5Transform(byte[] userKey, bool encryption)
            {
            ...
            {
                uint L = (uint)input[0] << 24 | (uint)input[1] << 16 | (uint)input[2] << 8 | input[3];
                uint R = (uint)input[4] << 24 | (uint)input[5] << 16 | (uint)input[6] << 8 | input[7];

                var result = encryption ? CAST_Encipher(L, R) : CAST_Decipher(L, R);

                output[0] = (byte)(result.Ri >> 24);
                output[1] = (byte)(result.Ri >> 16);
                output[2] = (byte)(result.Ri >> 8);
                output[3] = (byte)result.Ri;
                output[4] = (byte)(result.Li >> 24);
                output[5] = (byte)(result.Li >> 16);
                output[6] = (byte)(result.Li >> 8);
                output[7] = (byte)result.Li;
            ...
            private int rounds = MAX_ROUNDS;

            /// <summary>
            /// Creates the subkeys using the same nomenclature as described in RFC2144, section 2.4
            /// </summary>
            private void SetKey(byte[] key)
            {
                ...
                zCF = x47 ^ S5[z[0xA]] ^ S6[z[0x9]] ^ S7[z[0xB]] ^ S8[z[0x8]] ^ S6[x[0xB]];
                Bits32ToInts(zCF, z, 0xC);
                Kr[1] = (int)((S5[z[0x8]] ^ S6[z[0x9]] ^ S7[z[0x7]] ^ S8[z[0x6]] ^ S5[z[0x2]]) & 0x1f);
                Kr[2] = (int)((S5[z[0xA]] ^ S6[z[0xB]] ^ S7[z[0x5]] ^ S8[z[0x4]] ^ S6[z[0x6]]) & 0x1f);
                Kr[3] = (int)((S5[z[0xC]] ^ S6[z[0xD]] ^ S7[z[0x3]] ^ S8[z[0x2]] ^ S7[z[0x9]]) & 0x1f);
                Kr[4] = (int)((S5[z[0xE]] ^ S6[z[0xF]] ^ S7[z[0x1]] ^ S8[z[0x0]] ^ S8[z[0xC]]) & 0x1f);
                ...
                xCF = zCF ^ S5[x[0xA]] ^ S6[x[0x9]] ^ S7[x[0xB]] ^ S8[x[0x8]] ^ S6[z[0x3]];
                Bits32ToInts(xCF, x, 0xC);
                Kr[5] = (int)((S5[x[0x3]] ^ S6[x[0x2]] ^ S7[x[0xC]] ^ S8[x[0xD]] ^ S5[x[0x8]]) & 0x1f);
                Kr[6] = (int)((S5[x[0x1]] ^ S6[x[0x0]] ^ S7[x[0xE]] ^ S8[x[0xF]] ^ S6[x[0xD]]) & 0x1f);
                Kr[7] = (int)((S5[x[0x7]] ^ S6[x[0x6]] ^ S7[x[0x8]] ^ S8[x[0x9]] ^ S7[x[0x3]]) & 0x1f);
                Kr[8] = (int)((S5[x[0x5]] ^ S6[x[0x4]] ^ S7[x[0xA]] ^ S8[x[0xB]] ^ S8[x[0x7]]) & 0x1f);
                ...
                zCF = x47 ^ S5[z[0xA]] ^ S6[z[0x9]] ^ S7[z[0xB]] ^ S8[z[0x8]] ^ S6[x[0xB]];
                Bits32ToInts(zCF, z, 0xC);
                Kr[9] = (int)((S5[z[0x3]] ^ S6[z[0x2]] ^ S7[z[0xC]] ^ S8[z[0xD]] ^ S5[z[0x9]]) & 0x1f);
                Kr[10] = (int)((S5[z[0x1]] ^ S6[z[0x0]] ^ S7[z[0xE]] ^ S8[z[0xF]] ^ S6[z[0xc]]) & 0x1f);
                Kr[11] = (int)((S5[z[0x7]] ^ S6[z[0x6]] ^ S7[z[0x8]] ^ S8[z[0x9]] ^ S7[z[0x2]]) & 0x1f);
                Kr[12] = (int)((S5[z[0x5]] ^ S6[z[0x4]] ^ S7[z[0xA]] ^ S8[z[0xB]] ^ S8[z[0x6]]) & 0x1f);
                ...
                xCF = zCF ^ S5[x[0xA]] ^ S6[x[0x9]] ^ S7[x[0xB]] ^ S8[x[0x8]] ^ S6[z[0x3]];
                Bits32ToInts(xCF, x, 0xC);
                Kr[13] = (int)((S5[x[0x8]] ^ S6[x[0x9]] ^ S7[x[0x7]] ^ S8[x[0x6]] ^ S5[x[0x3]]) & 0x1f);
                Kr[14] = (int)((S5[x[0xA]] ^ S6[x[0xB]] ^ S7[x[0x5]] ^ S8[x[0x4]] ^ S6[x[0x7]]) & 0x1f);
                Kr[15] = (int)((S5[x[0xC]] ^ S6[x[0xD]] ^ S7[x[0x3]] ^ S8[x[0x2]] ^ S7[x[0x8]]) & 0x1f);
                Kr[16] = (int)((S5[x[0xE]] ^ S6[x[0xF]] ^ S7[x[0x1]] ^ S8[x[0x0]] ^ S8[x[0xD]]) & 0x1f);
            }
            ...
            private (uint Ri, uint Li) CAST_Encipher(uint L0, uint R0)
            {
            ...
            internal (uint Ri, uint Li) CAST_Decipher(uint L16, uint R16)
            {
