...
namespace Org.BouncyCastle.Bcpg.OpenPgp.Tests
{
    ...
    public class PgpKeyRingTest
    {
        ...
        private static readonly byte[] sec1 = Convert.FromBase64String(
        ...
        private static readonly byte[] sec2 = Convert.FromBase64String(
        ...
        private static readonly byte[] sec3 = Convert.FromBase64String(
        ...
        // GPG comment packets.
        //
        private static readonly byte[] sec4 = Convert.FromBase64String(
        ...
        //
        private static readonly byte[] pub5 = Convert.FromBase64String(
        ...
        private static readonly byte[] sec5 = Convert.FromBase64String(
        ...
        //
        private static readonly byte[] pub6 = Convert.FromBase64String(
        ...
        private static readonly byte[] pub6check = Convert.FromBase64String("62O9");

        //
        // revoked master key
        //
        private static readonly byte[] pub7 = Convert.FromBase64String(
        ...
        private static readonly byte[] pub7sub = Convert.FromBase64String(
        ...
        private static readonly byte[] pub8 = Convert.FromBase64String(
        ...
        private static readonly byte[] sec8 = Convert.FromBase64String(
        ...
        private static readonly byte[] sec10 = Convert.FromBase64String(
        ...
        //
        private static readonly byte[] rewrapKey = Convert.FromBase64String(
        ...
        private static readonly byte[] secWithPersonalCertificate = Convert.FromBase64String(
        ...
        private static readonly byte[] privv3 = Convert.FromBase64String(
        ...
        private static readonly byte[] probExpPubKey = Convert.FromBase64String(
