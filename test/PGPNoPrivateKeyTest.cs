...
namespace Org.BouncyCastle.Bcpg.OpenPgp.Tests
{
    ...
    public class PgpNoPrivateKeyTest
    {
        ...
        private static readonly byte[] pgpPrivateEmpty = Convert.FromBase64String(
        ...
        private static readonly byte[] pgpPrivateFull = Convert.FromBase64String(
        ...
        public void PerformTest()
        {
            ...
            try
            {
                PgpSecretKey pgpChangedKey = PgpSecretKey.CopyWithNewPassword(pgpSecKey, pgpOldPass, pgpNewPass);
            }
